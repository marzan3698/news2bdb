...
<div class="container py-4">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-white border">
            ...
            <li class="breadcrumb-item active" aria-current="page">সংবাদের অবস্থান</li>
            @if(isset($division))
            ...
            <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="news-card h-100 d-flex flex-column">
                            ...
                            <div class="card-body flex-grow-1 p-3">
                                <span class="text-danger fw-bold text-decoration-none" style="font-size: 14px;">{{ $article->category->name ?? '' }}</span>
                ...
                @empty
                    <div class="col-12 text-center py-5">
                        <p class="text-muted" style="font-size: 18px;">এই এলাকায় কোনো সংবাদ পাওয়া যায়নি।</p>
                    </div>
                @endforelse
            </div>
