<?php
$c = curl_init();
curl_setopt($c, CURLOPT_URL, 'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash-exp:generateContent?key=AIzaSyDcU66Bs5myHz3YBbCwetJEG6INzOgyFio');
